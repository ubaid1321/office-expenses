      ...
      <aside className="w-60 shrink-0 bg-white border-r border-gray-100 flex flex-col">
        ...
        <div className="px-5 py-5 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-semibold text-gray-900 text-sm leading-tight">Office Expenses</p>
              <p className="text-xs text-gray-400">Budget Tracker</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className={`text-xs font-semibold ${user?.role === 'admin' ? 'text-amber-600' : 'text-gray-400'}`}>
